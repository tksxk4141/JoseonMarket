...
public class LightManager : MonoBehaviour
{
    ...
    public GameObject SkyLanternController;
    public GameObject SkyLanternController1;
    ...
    private void Update()
    {
        ...
        if(TimeOfDay >= 1300)
        {
            if (TimeOfDay >= 1420) //밤이 끝나면 풍등날리기 종료
            {
                SkyLanternController.GetComponent<SkyLanternController>().EndOfDay = false;
                SkyLanternController1.GetComponent<SkyLanternController1>().EndOfDay = false;
            }
            else
            {
                SkyLanternController.GetComponent<SkyLanternController>().EndOfDay = true;
                SkyLanternController1.GetComponent<SkyLanternController1>().EndOfDay = true;
            }
        }
    }
